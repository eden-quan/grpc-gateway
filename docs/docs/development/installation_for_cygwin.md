...
Then `go get -u -v` the following packages:
    ...
    go get -u -v gitlab.lainuoniao.cn/eden-quan/grpc-gateway/protoc-gen-grpc-gateway
    go get -u -v gitlab.lainuoniao.cn/eden-quan/grpc-gateway/protoc-gen-openapiv2
...
This will probably fail with a similar output to this:
    ...
    package gitlab.lainuoniao.cn/eden-quan/grpc-gateway/protoc-gen-grpc-gateway: exit status 128
