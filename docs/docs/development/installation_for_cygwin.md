...
Then `go get -u -v` the following packages:
    ...
    go get -u -v github.com/eden-quan/grpc-gateway/protoc-gen-grpc-gateway
    go get -u -v github.com/eden-quan/grpc-gateway/protoc-gen-openapiv2
...
This will probably fail with a similar output to this:
    ...
    package github.com/eden-quan/grpc-gateway/protoc-gen-grpc-gateway: exit status 128
