...
gulp.task('server', shell.task([
  'go build -o bin/example-server gitlab.lainuoniao.cn/rhinobird/backend/grpc-gateway.git/examples/internal/cmd/example-grpc-server',
]));

gulp.task('gateway', shell.task([
  'go build -o bin/example-gw gitlab.lainuoniao.cn/rhinobird/backend/grpc-gateway.git/examples/internal/cmd/example-gateway-server',
]));
