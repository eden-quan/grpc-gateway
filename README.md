...
import (
    _ "github.com/sinsay/grpc-gateway/protoc-gen-grpc-gateway"
    _ "github.com/sinsay/grpc-gateway/protoc-gen-openapiv2-fx"
...
```sh
$ go install \
    github.com/sinsay/grpc-gateway/protoc-gen-grpc-gateway \
    github.com/sinsay/grpc-gateway/protoc-gen-openapiv2-fx \
...
```shell
$ go get github.com/sinsay/grpc-gateway@v2.16.2
```
