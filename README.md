...
import (
    _ "gitlab.lainuoniao.cn/rhinobird/backend/grpc-gateway.git/protoc-gen-grpc-gateway"
    _ "gitlab.lainuoniao.cn/rhinobird/backend/grpc-gateway.git/protoc-gen-openapiv2-fx"
...
```sh
$ go install \
    gitlab.lainuoniao.cn/rhinobird/backend/grpc-gateway.git/protoc-gen-grpc-gateway \
    gitlab.lainuoniao.cn/rhinobird/backend/grpc-gateway.git/protoc-gen-openapiv2-fx \
...
```shell
$ go get gitlab.lainuoniao.cn/rhinobird/backend/grpc-gateway.git@v2.16.2
```
